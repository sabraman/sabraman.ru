...
export function HomeHeroClient({ copy, locale }: HomeHeroClientProps) {
			...
			>
				...
				{[
					...
					<motion.path
						...
						transition={{ duration: 3, delay: item.delay, ease: "easeInOut" }}
					/>
				))}
			</motion.svg>
