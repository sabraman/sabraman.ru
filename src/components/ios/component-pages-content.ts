...
export function getIosWheelPickerHubPath(_locale: Locale) {
  return `/components/ios-wheel-picker`;
}

export const IOS_WHEEL_PICKER_URLS = {
  direct: "https://sabraman.ru/r/ios-wheel-picker.json",
  registry: "https://sabraman.ru/r/registry.json",
  docs: "https://sabraman.ru/components/ios-wheel-picker",
} as const;

export const IOS_WHEEL_PICKER_INSTALL_COMMANDS = {
  bun: `bunx --bun shadcn@latest add ${IOS_WHEEL_PICKER_URLS.direct}`,
  npm: `npx shadcn@latest add ${IOS_WHEEL_PICKER_URLS.direct}`,
  pnpm: `pnpm dlx shadcn@latest add ${IOS_WHEEL_PICKER_URLS.direct}`,
  yarn: `yarn dlx shadcn@latest add ${IOS_WHEEL_PICKER_URLS.direct}`,
} as const;

export const IOS_WHEEL_PICKER_ALIAS_COMMANDS = {
  bun: "bunx --bun shadcn@latest add @sabraman/ios-wheel-picker",
  npm: "npx shadcn@latest add @sabraman/ios-wheel-picker",
  pnpm: "pnpm dlx shadcn@latest add @sabraman/ios-wheel-picker",
  yarn: "yarn dlx shadcn@latest add @sabraman/ios-wheel-picker",
} as const;

export const IOS_WHEEL_PICKER_DEPENDENCY_COMMANDS = {
...
export const IOS_WHEEL_PICKER_COMPONENTS_JSON_SNIPPET = `{
  "registries": {
    "@sabraman": "https://sabraman.ru/r/{name}.json"
  }
}`;

export const IOS_WHEEL_PICKER_USAGE_SNIPPET = `"use client";

import { useState } from "react";
import { IosPickerColumn, IosPickerContainer } from "@/components/ios-wheel-picker";
...
export const IOS_WHEEL_PICKER_MULTIPLE_SNIPPET = `"use client";
...
export const IOS_WHEEL_PICKER_FORM_SNIPPET = `"use client"
...
export const IOS_WHEEL_PICKER_SECTION_IDS = [
...
export const IOS_WHEEL_PICKER_DOCS_COPY = {
  title: "iOS 6 Wheel Picker",
  summary:
    "A registry-ready recreation of the legacy iOS time picker, tuned to the original glossy shell and framed so the wheel reads as 2 rows above, 1 selected row, and 2 rows below.",
  ...
  manualTitle:
    "Then copy the component source from the registry item into components/ios-wheel-picker.tsx",
  manualDescription:
...
export const IOS_WHEEL_PICKER_ASIDE_CARDS = [
  {
    kind: "output",
    title: "Output",
    segments: [
      { type: "text", value: "Installs to " },
      { type: "code", value: "components/ios-wheel-picker.tsx" },
      { type: "text", value: " so the final import stays " },
      { type: "code", value: "@/components/ios-wheel-picker" },
      { type: "text", value: "." },
    ],
  },
  {
...
export const IOS_WHEEL_PICKER_NOTES = [
  {
    title: "Alignment",
...
export const IOS_WHEEL_PICKER_REGISTRY_CARDS = [
  {
    title: "Item JSON",
    url: IOS_WHEEL_PICKER_URLS.direct,
    action: "Open item",
  },
  {
    title: "Registry index",
    url: IOS_WHEEL_PICKER_URLS.registry,
    action: "Open registry",
  },
  {
    title: "Docs URL",
    url: IOS_WHEEL_PICKER_URLS.docs,
