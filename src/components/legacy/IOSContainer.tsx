...
import { LegacyUiLocaleProvider } from "./legacy-locale-context";
import {
...
export default function IOSContainer({ locale }: { locale: SupportedLocale }) {
