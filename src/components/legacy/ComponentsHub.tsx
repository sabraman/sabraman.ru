...
function HubHeader({
	...
	return (
		<header className="border-white/8 border-y">
			...
			<div className="border-white/8 border-t px-2 py-4 md:px-0 md:py-5">
				<p className="max-w-3xl font-mono text-[#9aa3b8] text-[clamp(0.98rem,2.2vw,1.08rem)] leading-relaxed">
					A collection of reusable legacy skeuomorphic components. Trusted
					registry for shadcn/ui.
				</p>
			</div>

			<div className="border-white/8 border-t px-2 py-4 md:px-0 md:py-6">
...
function PreviewStage({
	...
	return (
		<div
			className={cn(
				"relative flex min-h-[190px] w-full items-center justify-center px-4 py-5 sm:px-6 sm:py-6",
				className,
			)}
		>
...
function BarButtonPreview() {
	return (
		<PreviewStage className="min-h-[220px]">
			<LegacyBarButtonDemo className="mx-auto max-w-[520px]" />
		</PreviewStage>
	);
}
...
function SwitchPreview() {
	return (
		<PreviewStage className="min-h-[190px]">
			<LegacySwitchDemo className="mx-auto max-w-[320px]" compact={true} />
		</PreviewStage>
	);
}
...
function SliderPreview() {
	return (
		<PreviewStage className="min-h-[260px]">
			<LegacySliderDemo className="mx-auto max-w-[430px]" compact={true} />
		</PreviewStage>
	);
}
...
function ComponentSection({ description, href, preview, title }: ShowcaseItem) {
	...
	return (
		<motion.section
			...
			whileInView="visible"
			className="border-white/8 border-b px-2 py-8 md:px-0 md:py-9"
		>
		...
		<main className="relative min-h-screen overflow-hidden bg-[#03050a] text-white selection:bg-white/14">
			...
			<div
				className={cn(
					...
					"max-w-5xl gap-0 px-6 py-6 md:px-10 md:py-8",
				)}
			>
				<HubHeader
					items={showcases}
