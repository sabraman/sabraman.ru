...
export async function GET(request: Request) {
	try {
		...
		const websiteUrl = "sabraman.ru";

		// Load Inter Tight font with weight 900 for bold typography
		const fontData = await loadGoogleFont(
			"Inter+Tight:wght@900",
			(title || "") + (subtitle || ""),
		);
			...
			>
				...
				<div
					style={{
						...
						bottom: 0,
						background: `
								radial-gradient(circle at 20% 20%, rgba(120, 120, 250, 0.15) 0%, transparent 50%),
								radial-gradient(circle at 80% 80%, rgba(120, 120, 250, 0.1) 0%, transparent 50%),
								radial-gradient(circle at 40% 60%, rgba(100, 200, 250, 0.08) 0%, transparent 50%),
								linear-gradient(135deg, rgba(120, 120, 250, 0.05) 0%, transparent 50%)
							`,
					}}
				/>
					...
					>
						...
						<div
							style={{
								...
								height: "220px",
								background:
									"radial-gradient(circle, rgba(120, 120, 250, 0.2) 0%, transparent 70%)",
								borderRadius: "50%",
								filter: "blur(20px)",
							}}
						/>
						<svg
							...
							style={{
								filter: "drop-shadow(0 0 30px rgba(120, 120, 250, 0.4))",
								position: "relative",
								zIndex: 2,
							}}
							role="img"
